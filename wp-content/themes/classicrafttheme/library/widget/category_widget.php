...
class CC_Widget_Categories extends WP_Widget {
    ...
    function __construct() {
        ...
        parent::__construct('custom-categories', __('Sweetico Categories'), $widget_ops);
    }

    function widget($args, $instance) {
        extract($args);

        $title = apply_filters('widget_title', empty($instance['title']) ? __('Sweetico Categories') : $instance['title'], $instance, $this->id_base);

...
function cc_admin_menu() {
    add_menu_page(__('RentHUB', THEME_SLUG), __('Settings', THEME_SLUG), 'read', basename(__FILE__), 'inkthemes_optionsframework_add_admin', TEMPLATEURL . '/images/setting.png', 4);

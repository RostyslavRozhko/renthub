        ...
        <div class="grid_24">
            ...
            <div class="grid_12 omega">
                <div class="bottom_content">
                    ...
                    ?>
                    <p style="float:<?php echo $style; ?>" class="copyright"><?php if(cc_get_option('cc_footertext') != ''){ echo cc_get_option('cc_footertext');} else{ ?>&copy; <?php echo date('Y'); ?> Sweetico. All Right Reserved.<?php } ?></p>
                </div>
            </div>
        </div>
        <div class="clear"></div>

            ...
            if ($leads):
                foreach ($leads as $lead):
                    ...
                    <tr class="<?php if ($count % 2 == 0) echo "even"; else echo "odd"; ?>">                                                
                        ...
                        <td><?php echo $lead->lead_ad_title; ?></td> 
                        ...
                        <td><a title="Delete lead" href="<?php echo site_url(CC_DASHBOARD . "?action=lead&id=$lead->ID"); ?>"><img src="<?php echo TEMPLATEURL . '/images/delete.png'; ?>"/>Видалити</a></td>
                    </tr>  
                    <?php
                    $count++;
                endforeach;
